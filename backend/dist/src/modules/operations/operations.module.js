...
exports.OperationsModule = OperationsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [operations_controller_1.ReceiptsController, operations_controller_1.DispatchesController, operations_controller_1.TransfersController, operations_controller_1.StockCountsController],
    })
], OperationsModule);
