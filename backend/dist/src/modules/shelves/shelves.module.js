...
exports.ShelvesModule = ShelvesModule = __decorate([
    (0, common_1.Module)({ controllers: [shelves_controller_1.ShelvesController], providers: [shelves_service_1.ShelvesService] })
], ShelvesModule);
